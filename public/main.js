...
function SmartHome() {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    this.requestSync.addEventListener('click', async () => {
      try {
        const response = await fetch('https://us-central1-smartstovepoc-31305.cloudfunctions.net/requestsync');
...
SmartHome.prototype.initFirebase = () => {
  ...
  //initializeApp({
  //  databaseURL: "https://smartstovepoc-31305-default-rtdb.europe-west1.firebasedatabase.app"
  //});
};
